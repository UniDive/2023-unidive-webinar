...
Take the text in English \href{https://github.com/UniDive/2023-unidive-webinar/blob/main/parseme-tutorial/corpus-en.txt}{\beamergotobutton{here}} and try to annotate the following sentences (FLAT is not required):
